    ...
    <div className="p-4 sm:p-6">
      <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6 mb-4">
        <div className="flex items-center justify-between mb-2">
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Appointments (Your Region)</h1>
        ...
        <p className="text-sm text-gray-600">Booked appointments across outlets in your region.</p>
      </div>
