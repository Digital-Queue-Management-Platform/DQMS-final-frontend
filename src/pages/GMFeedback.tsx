        ...
        <div className="p-4 sm:p-6 lg:p-8 min-h-screen bg-gray-50">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 mb-6 flex flex-wrap items-end gap-3">
                <div>
                    ...
                    <select value={rating} onChange={e => setRating(e.target.value)} className="border border-gray-200 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-violet-500 focus:outline-none">
                ...
                <div>
                    ...
                    <input type="date" value={startDate} onChange={e => setStartDate(e.target.value)} className="border border-gray-200 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-violet-500 focus:outline-none" />
                </div>
                <div>
                    <label className="block text-xs font-medium text-gray-500 mb-1">To</label>
                    <input type="date" value={endDate} onChange={e => setEndDate(e.target.value)} className="border border-gray-200 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-violet-500 focus:outline-none" />
                </div>
                    ...
                    {totalPages > 1 && (
                        <div className="flex items-center justify-between bg-white rounded-2xl border border-gray-100 shadow-sm p-4 mt-4">
                            ...
                            <div className="flex gap-2">
                                ...
                                <button onClick={() => setPage(p => Math.min(totalPages, p + 1))} disabled={page === totalPages} className="p-2 rounded-lg border border-gray-200 disabled:opacity-40 hover:bg-gray-50 transition-colors">
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg p-6 relative">
                        ...
                        <div className="space-y-3 text-sm">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                ...
                                <div className="bg-gray-50 rounded-xl p-3"><p className="text-xs text-gray-500 mb-1">Outlet</p><p className="font-medium">{selected.token?.outlet?.name}</p><p className="text-gray-500">{selected.token?.outlet?.region?.name}</p></div>
                            </div>
                            <div className="bg-gray-50 rounded-xl p-3">
