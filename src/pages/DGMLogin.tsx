        ...
        <div className="bg-white rounded-2xl p-8 shadow-xl shadow-teal-100/60 border border-teal-100">
          <div className="text-center mb-8">
            ...
            >
              ...
              <img src="/Transzent Logo.png" alt="Transzent Logo" className="h-14 w-auto object-contain drop-shadow-[0_0_15px_rgba(13,148,136,0.2)]" />
            </motion.div>
            <p className="text-teal-600 font-semibold text-xs tracking-widest uppercase mb-1">Welcome to the DQMS System</p>
