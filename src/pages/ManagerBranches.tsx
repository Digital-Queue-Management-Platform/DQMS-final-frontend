...
interface Branch {
  ...
  rating: number;
  teleshopManager?: { name?: string } | null;
}
        ...
        outlets.map(async (outlet: any) => {
          try {
            ...
            return {
              ...
              teleshopManager: outlet.teleshopManagers?.[0] || null,
            } as Branch
          } catch (e) {
            ...
            {branches.map((branch) => (
              <div key={branch.id} className="relative bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition-shadow">
                ...
                <div className="border-t border-gray-200 pt-4">
                  ...
                  <div className="flex justify-between text-sm mt-1">
                    <span className="text-gray-600">Teleshop Manager:</span>
                    <span className="font-medium text-gray-900">
                      {branch.teleshopManager?.name ? (
                        branch.teleshopManager.name
                      ) : (
