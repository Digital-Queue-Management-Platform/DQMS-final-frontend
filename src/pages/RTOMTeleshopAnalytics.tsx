...
export default function RTOMTeleshopAnalytics() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <ManagerTopBar manager={manager} title="Teleshop Analytics" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-8 gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Teleshop Analytics</h1>
              <p className="text-gray-600 mt-1">Outlet-Level Analytics</p>
              <p className="text-sm text-gray-500">View live analytics for individual outlets within your assigned regions.</p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="flex items-center gap-1 bg-white rounded-lg p-1 shadow-sm border">
              {['Today', 'Weekly', 'Monthly', 'Annual'].map((period) => (
                <button
                  key={period}
        ...
        {selectedOutletData && (
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200 mb-8">
            <div className="flex items-start justify-between">
              <div>
                <h2 className="text-2xl font-bold text-gray-900">{selectedOutletData.name}</h2>
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              ...
              >
                ...
                <p className="text-3xl font-bold text-gray-900">{metrics?.totalCustomers || 0}</p>
              ...
              >
                ...
                <p className="text-3xl font-bold text-gray-900">{metrics?.avgWaitTime || 0} min</p>
                <div className="flex items-center mt-2">
              ...
              >
                ...
                <p className="text-3xl font-bold text-gray-900">{metrics?.avgServiceTime || 0} min</p>
                <div className="flex items-center mt-2">
                  <TrendingDown className="w-4 h-4 text-green-500 mr-1" />
              ...
              >
                ...
                <p className="text-3xl font-bold text-gray-900">{metrics?.customerSatisfaction || 0}/5</p>
                <div className="flex items-center mt-2">
                  <TrendingUp className="w-4 h-4 text-green-500 mr-1" />
