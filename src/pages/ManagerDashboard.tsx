      ...
      <div className="mx-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-4 sm:p-5">
            <div className="flex items-center justify-between">
              <div className="min-w-0 flex-1">
                <p className="text-xs sm:text-sm font-semibold text-slate-700 mb-1 leading-tight">Customers Served</p>
                <p className="text-xl sm:text-2xl font-bold text-slate-900">{regionStats.totalCustomersServed}</p>
              </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-4 sm:p-5">
            <div className="flex items-center justify-between">
              <div className="min-w-0 flex-1">
                <p className="text-xs sm:text-sm font-semibold text-slate-700 mb-1 leading-tight">Avg Wait Time</p>
                <p className="text-xl sm:text-2xl font-bold text-slate-900">{regionStats.avgRegionalWaitTime}m</p>
              </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-4 sm:p-5">
            <div className="flex items-center justify-between">
              <div className="min-w-0 flex-1">
                <p className="text-xs sm:text-sm font-semibold text-slate-700 mb-1 leading-tight">Regional Rating</p>
                <p className="text-xl sm:text-2xl font-bold text-slate-900">{regionStats.avgRegionalRating}</p>
              </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-4 sm:p-5">
            <div className="flex items-center justify-between">
              <div className="min-w-0 flex-1">
                <p className="text-xs sm:text-sm font-semibold text-slate-700 mb-1 leading-tight">Active Branches</p>
                <p className="text-xl sm:text-2xl font-bold text-slate-900">{regionStats.totalActiveBranches}</p>
              </div>
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-purple-100 rounded-xl flex items-center justify-center flex-shrink-0 ml-3">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-4 sm:p-5">
            <div className="flex items-center justify-between">
              <div className="min-w-0 flex-1">
                <p className="text-xs sm:text-sm font-semibold text-slate-700 mb-1 leading-tight">Active Officers</p>
                <p className="text-xl sm:text-2xl font-bold text-slate-900">{regionStats.totalActiveOfficers}</p>
              </div>
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-indigo-100 rounded-xl flex items-center justify-center flex-shrink-0 ml-3">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-4 sm:p-5">
            <div className="flex items-center justify-between">
              <div className="min-w-0 flex-1">
                <p className="text-xs sm:text-sm font-semibold text-slate-700 mb-1 leading-tight">Currently Waiting</p>
                <p className="text-xl sm:text-2xl font-bold text-slate-900">{regionStats.totalCustomersWaiting}</p>
              </div>
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-orange-100 rounded-xl flex items-center justify-center flex-shrink-0 ml-3">
